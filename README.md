...
Parser (building an internal representation / AST)

Semantic checks

Runtime evaluator executing user programs

Modular architecture designed for extensibility

## Goals

Explore how interpreters and compilers work at a low level

Build a structured and maintainable codebase for a non-trivial system

Gain hands-on experience with language design and execution models

Demonstrate clean architecture practices for systems projects
